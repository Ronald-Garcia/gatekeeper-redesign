...
describe('User tests', () => {
  ...
  //TODO, have to actually flesh this test after doing the sorting options.
  it('Delete a user and remove it from the dashboard', () => {
    // Set up interception of user delete request for later.
    cy.intercept('POST', '**/users*', (req) => {}).as("createUser");
